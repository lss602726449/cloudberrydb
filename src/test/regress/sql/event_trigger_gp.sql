...
CREATE OR REPLACE FUNCTION write_to_file() RETURNS integer as :'gpextprotocol', 'demoprot_export' LANGUAGE C STABLE NO SQL;
CREATE OR REPLACE FUNCTION read_from_file() RETURNS integer as :'gpextprotocol', 'demoprot_import' LANGUAGE C STABLE NO SQL;
